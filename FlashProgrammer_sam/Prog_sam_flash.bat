...
@echo programming sam_Output_LDR_Files/%1-SC589.ldr to flash
cldp.exe -verbose -proc ADSP-SC589 -core 1 -emu 2000 -driver Supporting_Files/w25ql512fv_dpia_SC589_SHARC_Core1.dxe -cmd prog -erase affected -format bin -file sam_Output_LDR_Files/%1-SC589.ldr 
@echo Done!
goto :eof
)
