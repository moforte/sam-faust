  ...
  public:
	...
	void fillmydspSIG0(int count, float* output) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec28[0] = (iRec28[1] + 1);
			output[i] = std::cos((9.58738019e-05f * float((iRec28[0] + -1))));
			iRec28[1] = iRec28[0];
...
class mydspSIG1 {
  ...
  public:
	...
	void fillmydspSIG1(int count, float* output) {
		for (int i = 0; (i < count); i = (i + 1)) {
			iRec31[0] = (iRec31[1] + 1);
			output[i] = std::sin((9.58738019e-05f * float((iRec31[0] + -1))));
			iRec31[1] = iRec31[0];
...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceConstants(int samplingFreq) {
		...
		fConst5 = (6.90999985f / fConst0);
		fConst6 = (0.333333343f / fConst0);
		fConst7 = (1.0f / fConst0);
		fConst8 = (0.142857149f / fConst0);
		fConst9 = (0.5f / fConst0);
		fConst10 = (0.25f / fConst0);
		fConst11 = (0.166666672f / fConst0);
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider1 = FAUSTFLOAT(0.33329999999999999f);
		...
		fVslider17 = FAUSTFLOAT(0.22f);
		fVslider18 = FAUSTFLOAT(0.0f);
		fVslider19 = FAUSTFLOAT(0.75f);
		fVslider20 = FAUSTFLOAT(0.5f);
		fVslider21 = FAUSTFLOAT(0.5f);
		fVslider22 = FAUSTFLOAT(0.5f);
	...
	virtual void instanceClear() {
		...
		for (int l60 = 0; (l60 < 256); l60 = (l60 + 1)) {
			fVec14[l60] = 0.0f;
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider14, "midi", "ctrl 61");
		ui_interface->declare(&fVslider14, "style", "knob");
		ui_interface->addVerticalSlider("Delay", &fVslider14, 0.5f, 0.00100000005f, 0.742038548f, 0.00100000005f);
		ui_interface->declare(&fVslider16, "0", "");
		ui_interface->declare(&fVslider16, "midi", "ctrl 62");
		ui_interface->declare(&fVslider16, "style", "knob");
		ui_interface->addVerticalSlider("Warp", &fVslider16, 0.0f, -1.0f, 1.0f, 0.00100000005f);
		...
		ui_interface->addVerticalSlider("Amp", &fVslider10, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fVslider11, "5", "");
		ui_interface->declare(&fVslider11, "midi", "ctrl 76");
		ui_interface->declare(&fVslider11, "style", "knob");
		ui_interface->addVerticalSlider("FeedbackSm", &fVslider11, 0.0f, 0.0f, 1.0f, 9.99999975e-06f);
		...
		ui_interface->declare(&fVslider17, "midi", "ctrl 50");
		ui_interface->declare(&fVslider17, "style", "knob");
		ui_interface->addVerticalSlider("Delay", &fVslider17, 0.219999999f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider9, "1", "");
		ui_interface->declare(&fVslider9, "midi", "ctrl 51");
		ui_interface->declare(&fVslider9, "style", "knob");
		ui_interface->declare(&fVslider9, "unit", "Hz");
		ui_interface->addVerticalSlider("Rate", &fVslider9, 0.5f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->declare(&fVslider19, "3", "");
		ui_interface->declare(&fVslider19, "midi", "ctrl 52");
		ui_interface->declare(&fVslider19, "style", "knob");
		ui_interface->addVerticalSlider("Depth", &fVslider19, 0.75f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fVslider7, "5", "");
		ui_interface->declare(&fVslider7, "midi", "ctrl 53");
		ui_interface->declare(&fVslider7, "style", "knob");
		ui_interface->addVerticalSlider("Feedback", &fVslider7, 0.0f, -0.995000005f, 0.99000001f, 0.00100000005f);
		ui_interface->declare(&fVslider8, "7", "");
		ui_interface->declare(&fVslider8, "midi", "ctrl 54");
		ui_interface->declare(&fVslider8, "style", "knob");
		ui_interface->addVerticalSlider("Waveshape", &fVslider8, 0.0f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openVerticalBox("Switches");
		ui_interface->declare(&fVslider6, "0", "");
		ui_interface->declare(&fVslider6, "midi", "ctrl 102");
		ui_interface->declare(&fVslider6, "style", "knob");
		ui_interface->addVerticalSlider("Enable", &fVslider6, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider18, "1", "");
		ui_interface->declare(&fVslider18, "midi", "ctrl 49");
		ui_interface->declare(&fVslider18, "style", "knob");
		ui_interface->addVerticalSlider("Invert", &fVslider18, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->declare(&fVslider20, "midi", "ctrl 55");
		ui_interface->declare(&fVslider20, "style", "knob");
		ui_interface->addVerticalSlider("Delay", &fVslider20, 0.5f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider22, "1", "");
		ui_interface->declare(&fVslider22, "midi", "ctrl 56");
		ui_interface->declare(&fVslider22, "style", "knob");
		ui_interface->declare(&fVslider22, "unit", "Hz");
		ui_interface->addVerticalSlider("Rate", &fVslider22, 0.5f, 0.00999999978f, 7.0f, 9.99999975e-05f);
		ui_interface->declare(&fVslider5, "4", "");
		ui_interface->declare(&fVslider5, "midi", "ctrl 57");
		ui_interface->declare(&fVslider5, "style", "knob");
		ui_interface->addVerticalSlider("Depth", &fVslider5, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fVslider21, "6", "");
		ui_interface->declare(&fVslider21, "midi", "ctrl 58");
		ui_interface->declare(&fVslider21, "style", "knob");
		ui_interface->addVerticalSlider("Deviation", &fVslider21, 0.5f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openVerticalBox("Switches");
		ui_interface->declare(&fVslider4, "0", "");
		ui_interface->declare(&fVslider4, "midi", "ctrl 103");
		ui_interface->declare(&fVslider4, "style", "knob");
		ui_interface->addVerticalSlider("Enable", &fVslider4, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		...
		ui_interface->addVerticalSlider("Damp", &fVslider3, 0.5f, 0.0f, 1.0f, 0.0250000004f);
		ui_interface->declare(&fVslider2, "midi", "ctrl 4");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->addVerticalSlider("RoomSize", &fVslider2, 0.5f, 0.0f, 1.0f, 0.0250000004f);
		ui_interface->declare(&fVslider1, "midi", "ctrl 79");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("Wet", &fVslider1, 0.333299994f, 0.0f, 1.0f, 0.0250000004f);
		ui_interface->closeBox();
		ui_interface->declare(0, "1", "");
		ui_interface->openVerticalBox("Switches");
		ui_interface->declare(&fVslider0, "0", "");
		ui_interface->declare(&fVslider0, "midi", "ctrl 104");
		ui_interface->declare(&fVslider0, "style", "knob");
		ui_interface->addVerticalSlider("Enable", &fVslider0, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		int iSlow0 = (1 - int(float(fVslider0)));
		float fSlow1 = float(fVslider1);
		float fSlow2 = ((0.280000001f * float(fVslider2)) + 0.699999988f);
		float fSlow3 = (0.400000006f * float(fVslider3));
		float fSlow4 = (1.0f - fSlow3);
		int iSlow5 = (1 - int(float(fVslider4)));
		float fSlow6 = (fConst2 * float(fVslider5));
		int iSlow7 = (1 - int(float(fVslider6)));
		float fSlow8 = (fConst2 * float(fVslider7));
		float fSlow9 = float(fVslider8);
		float fSlow10 = (fConst2 * float(fVslider9));
		...
		float fSlow19 = (((0.144717798f * fSlow18) > 0.0f)?std::exp((0.0f - (fConst5 / fSlow18))):0.0f);
		float fSlow20 = (1.0f - fSlow19);
		float fSlow21 = (fSlow17 * fSlow20);
		float fSlow22 = (float(fVslider16) * fSlow20);
		float fSlow23 = (2003.0f * float(fVslider17));
		int iSlow24 = int(float(fVslider18));
		float fSlow25 = (fConst2 * float(fVslider19));
		float fSlow26 = (8.19200039f * float(fVslider20));
		float fSlow27 = (6.2500003e-05f * float(fVslider21));
		float fSlow28 = (fConst2 * float(fVslider22));
		float fSlow29 = (1.0f - fSlow1);
		for (int i = 0; (i < count); i = (i + 1)) {
			iVec0[0] = 1;
			fRec9[0] = ((fSlow3 * fRec9[1]) + (fSlow4 * fRec8[1]));
			fRec10[0] = (fSlow6 + (fConst1 * fRec10[1]));
			fRec12[0] = (fSlow8 + (fConst1 * fRec12[1]));
			fRec14[0] = (fSlow10 + (fConst1 * fRec14[1]));
			float fTemp0 = (fRec13[1] + (fConst3 * fRec14[1]));
			fRec13[0] = (fTemp0 - std::floor(fTemp0));
			float fTemp1 = (fConst4 * fRec14[0]);
			...
			float fTemp4 = ((fSlow9 * (1.0f - std::fabs(((2.0f * fRec13[0]) + -1.0f)))) + (fSlow11 * (fRec15[0] + 1.0f)));
			float fTemp5 = float(input1[i]);
			fRec17[0] = (fSlow12 + (fConst1 * fRec17[1]));
			float fTemp6 = float(input0[i]);
			fRec20[(IOTA & 65535)] = ((fSlow14 * fRec20[((IOTA - 1) & 65535)]) + (fSlow13 * ((iSlow15?0.0f:(fTemp6 + fTemp5)) + (fSlow16 * fRec18[1]))));
			fRec21[0] = (fSlow21 + (fSlow19 * fRec21[1]));
			int iTemp7 = int(fRec21[0]);
			float fTemp8 = std::floor(fRec21[0]);
			fRec18[0] = ((fRec20[((IOTA - std::min(32769, std::max(0, iTemp7))) & 65535)] * (fTemp8 + (1.0f - fRec21[0]))) + ((fRec21[0] - fTemp8) * fRec20[((IOTA - std::min(32769, std::max(0, (iTemp7 + 1)))) & 65535)]));
			fRec23[0] = (fSlow22 + (fSlow19 * fRec23[1]));
			fRec24[0] = (fSlow19 * fRec24[1]);
			fRec22[0] = ((fSlow19 * fRec22[1]) + (fSlow17 * (fSlow20 * ((fRec23[0] + mydsp_faustpower2_f(fRec24[0])) + 1.0f))));
			int iTemp9 = int(fRec22[0]);
			float fTemp10 = std::floor(fRec22[0]);
			float fRec19 = ((fRec20[((IOTA - std::min(32769, std::max(0, iTemp9))) & 65535)] * (fTemp10 + (1.0f - fRec22[0]))) + ((fRec22[0] - fTemp10) * fRec20[((IOTA - std::min(32769, std::max(0, (iTemp9 + 1)))) & 65535)]));
			float fTemp11 = (fTemp5 + ((fRec17[0] * fRec19) + fTemp6));
			float fTemp12 = (iSlow7?0.0f:fTemp11);
			float fTemp13 = ((fRec12[0] * fRec11[1]) - fTemp12);
			fVec1[(IOTA & 4095)] = fTemp13;
			float fTemp14 = (fSlow23 * fTemp4);
			float fTemp15 = (fTemp14 + 44.0f);
			int iTemp16 = int(fTemp15);
			float fTemp17 = std::floor(fTemp15);
			fRec11[0] = ((fVec1[((IOTA - std::min(2049, std::max(0, iTemp16))) & 4095)] * (fTemp17 + (-43.0f - fTemp14))) + ((fTemp14 + (44.0f - fTemp17)) * fVec1[((IOTA - std::min(2049, std::max(0, (iTemp16 + 1)))) & 4095)]));
			fRec25[0] = (fSlow25 + (fConst1 * fRec25[1]));
			float fTemp18 = (iSlow7?fTemp11:(((fRec11[0] * (iSlow24?(0.0f - fRec25[0]):fRec25[0])) + fTemp12) / (fRec25[0] + 1.0f)));
			float fTemp19 = (iSlow5?0.0f:fTemp18);
			float fTemp20 = (fRec10[0] * fTemp19);
			fVec2[(IOTA & 8191)] = fTemp20;
			fRec26[0] = (fSlow26 + (0.999000013f * fRec26[1]));
			fRec27[0] = ((0.999000013f * fRec27[1]) + (fSlow27 * fRec26[0]));
			fRec30[0] = (fSlow28 + (fConst1 * fRec30[1]));
			float fTemp21 = (fRec29[1] + (fConst6 * fRec30[0]));
			fRec29[0] = (fTemp21 - std::floor(fTemp21));
			float fTemp22 = std::min(8192.0f, ((0.375f * fRec26[0]) + (fRec27[0] * ftbl0mydspSIG0[int((65536.0f * fRec29[0]))])));
			int iTemp23 = int(fTemp22);
			float fTemp24 = (fRec32[1] + (fConst7 * fRec30[0]));
			fRec32[0] = (fTemp24 - std::floor(fTemp24));
			float fTemp25 = std::min(8192.0f, ((0.125f * fRec26[0]) + (fRec27[0] * ftbl1mydspSIG1[int((65536.0f * fRec32[0]))])));
			int iTemp26 = int(fTemp25);
			float fTemp27 = ((1.0f - fRec10[0]) * fTemp19);
			float fTemp28 = (fRec33[1] + (fConst8 * fRec30[0]));
			fRec33[0] = (fTemp28 - std::floor(fTemp28));
			float fTemp29 = std::min(8192.0f, ((0.875f * fRec26[0]) + (fRec27[0] * (0.0f - ftbl0mydspSIG0[int((65536.0f * fRec33[0]))]))));
			int iTemp30 = int(fTemp29);
			float fTemp31 = (iSlow5?fTemp18:(((0.707106769f * ((fVec2[((IOTA - (iTemp23 & 8191)) & 8191)] * (float(iTemp23) + (1.0f - fTemp22))) + ((fTemp22 - float(iTemp23)) * fVec2[((IOTA - ((iTemp23 + 1) & 8191)) & 8191)]))) + (((fTemp25 - float(iTemp26)) * fVec2[((IOTA - ((iTemp26 + 1) & 8191)) & 8191)]) + (fTemp27 + (fVec2[((IOTA - (iTemp26 & 8191)) & 8191)] * (float(iTemp26) + (1.0f - fTemp25)))))) - (0.707106769f * ((fVec2[((IOTA - (iTemp30 & 8191)) & 8191)] * (float(iTemp30) + (1.0f - fTemp29))) + ((fTemp29 - float(iTemp30)) * fVec2[((IOTA - ((iTemp30 + 1) & 8191)) & 8191)])))));
			float fTemp32 = (iSlow0?0.0f:fTemp31);
			float fTemp33 = (fRec34[1] + (fConst9 * fRec30[0]));
			fRec34[0] = (fTemp33 - std::floor(fTemp33));
			int iTemp34 = int((65536.0f * fRec34[0]));
			float fTemp35 = std::min(8192.0f, ((0.25f * fRec26[0]) + (fRec27[0] * ((0.707106769f * ftbl1mydspSIG1[iTemp34]) + (0.707106769f * ftbl0mydspSIG0[iTemp34])))));
			int iTemp36 = int(fTemp35);
			float fTemp37 = (fRec35[1] + (fConst10 * fRec30[0]));
			fRec35[0] = (fTemp37 - std::floor(fTemp37));
			int iTemp38 = int((65536.0f * fRec35[0]));
			float fTemp39 = std::min(8192.0f, ((0.5f * fRec26[0]) + (fRec27[0] * ((0.707106769f * ftbl0mydspSIG0[iTemp38]) - (0.707106769f * ftbl1mydspSIG1[iTemp38])))));
			int iTemp40 = int(fTemp39);
			float fTemp41 = (fRec36[1] + (fConst11 * fRec30[0]));
			fRec36[0] = (fTemp41 - std::floor(fTemp41));
			int iTemp42 = int((65536.0f * fRec36[0]));
			float fTemp43 = std::min(8192.0f, ((0.75f * fRec26[0]) + (fRec27[0] * (0.0f - ((0.707106769f * ftbl1mydspSIG1[iTemp42]) + (0.707106769f * ftbl0mydspSIG0[iTemp42]))))));
			int iTemp44 = int(fTemp43);
			float fTemp45 = (fRec37[1] + (fConst12 * fRec30[0]));
			fRec37[0] = (fTemp45 - std::floor(fTemp45));
			int iTemp46 = int((65536.0f * fRec37[0]));
			float fTemp47 = std::min(8192.0f, (fRec26[0] + (fRec27[0] * ((0.707106769f * ftbl1mydspSIG1[iTemp46]) - (0.707106769f * ftbl0mydspSIG0[iTemp46])))));
			int iTemp48 = int(fTemp47);
			float fTemp49 = (iSlow5?fTemp18:(fTemp27 - (((0.382683426f * ((fVec2[((IOTA - (iTemp36 & 8191)) & 8191)] * (float(iTemp36) + (1.0f - fTemp35))) + ((fTemp35 - float(iTemp36)) * fVec2[((IOTA - ((iTemp36 + 1) & 8191)) & 8191)]))) + (0.923879504f * (((fVec2[((IOTA - (iTemp40 & 8191)) & 8191)] * (float(iTemp40) + (1.0f - fTemp39))) + ((fTemp39 - float(iTemp40)) * fVec2[((IOTA - ((iTemp40 + 1) & 8191)) & 8191)])) + ((fVec2[((IOTA - (iTemp44 & 8191)) & 8191)] * (float(iTemp44) + (1.0f - fTemp43))) + ((fTemp43 - float(iTemp44)) * fVec2[((IOTA - ((iTemp44 + 1) & 8191)) & 8191)]))))) + (0.382683426f * ((fVec2[((IOTA - (iTemp48 & 8191)) & 8191)] * (float(iTemp48) + (1.0f - fTemp47))) + ((fTemp47 - float(iTemp48)) * fVec2[((IOTA - ((iTemp48 + 1) & 8191)) & 8191)]))))));
			float fTemp50 = (iSlow0?0.0f:fTemp49);
			float fTemp51 = (0.0149999997f * (fTemp32 + fTemp50));
			fVec3[(IOTA & 2047)] = ((fSlow2 * fRec9[0]) + fTemp51);
			fRec8[0] = fVec3[((IOTA - 1116) & 2047)];
			fRec39[0] = ((fSlow3 * fRec39[1]) + (fSlow4 * fRec38[1]));
			fVec4[(IOTA & 2047)] = (fTemp51 + (fSlow2 * fRec39[0]));
			fRec38[0] = fVec4[((IOTA - 1188) & 2047)];
			fRec41[0] = ((fSlow3 * fRec41[1]) + (fSlow4 * fRec40[1]));
			fVec5[(IOTA & 2047)] = (fTemp51 + (fSlow2 * fRec41[0]));
			fRec40[0] = fVec5[((IOTA - 1277) & 2047)];
			fRec43[0] = ((fSlow3 * fRec43[1]) + (fSlow4 * fRec42[1]));
			fVec6[(IOTA & 2047)] = (fTemp51 + (fSlow2 * fRec43[0]));
			fRec42[0] = fVec6[((IOTA - 1356) & 2047)];
			fRec45[0] = ((fSlow3 * fRec45[1]) + (fSlow4 * fRec44[1]));
			fVec7[(IOTA & 2047)] = (fTemp51 + (fSlow2 * fRec45[0]));
			fRec44[0] = fVec7[((IOTA - 1422) & 2047)];
			fRec47[0] = ((fSlow3 * fRec47[1]) + (fSlow4 * fRec46[1]));
			fVec8[(IOTA & 2047)] = (fTemp51 + (fSlow2 * fRec47[0]));
			fRec46[0] = fVec8[((IOTA - 1491) & 2047)];
			fRec49[0] = ((fSlow3 * fRec49[1]) + (fSlow4 * fRec48[1]));
			fVec9[(IOTA & 2047)] = (fTemp51 + (fSlow2 * fRec49[0]));
			fRec48[0] = fVec9[((IOTA - 1557) & 2047)];
			fRec51[0] = ((fSlow3 * fRec51[1]) + (fSlow4 * fRec50[1]));
			fVec10[(IOTA & 2047)] = (fTemp51 + (fSlow2 * fRec51[0]));
			fRec50[0] = fVec10[((IOTA - 1617) & 2047)];
			float fTemp52 = (((((((fRec8[0] + fRec38[0]) + fRec40[0]) + fRec42[0]) + fRec44[0]) + fRec46[0]) + fRec48[0]) + fRec50[0]);
			fVec11[(IOTA & 1023)] = (fTemp52 + (0.5f * fRec6[1]));
			fRec6[0] = fVec11[((IOTA - 556) & 1023)];
			float fRec7 = (fRec6[1] - fTemp52);
			fVec12[(IOTA & 511)] = (fRec7 + (0.5f * fRec4[1]));
			fRec4[0] = fVec12[((IOTA - 441) & 511)];
			float fRec5 = (fRec4[1] - fRec7);
			fVec13[(IOTA & 511)] = (fRec5 + (0.5f * fRec2[1]));
			fRec2[0] = fVec13[((IOTA - 341) & 511)];
			float fRec3 = (fRec2[1] - fRec5);
			fVec14[(IOTA & 255)] = (fRec3 + (0.5f * fRec0[1]));
			fRec0[0] = fVec14[((IOTA - 225) & 255)];
			float fRec1 = (fRec0[1] - fRec3);
			float fTemp53 = (fSlow1 * fRec1);
			output0[i] = FAUSTFLOAT((iSlow0?fTemp31:(fTemp53 + (fSlow29 * fTemp32))));
			output1[i] = FAUSTFLOAT((iSlow0?fTemp49:(fTemp53 + (fSlow29 * fTemp50))));
			iVec0[1] = iVec0[0];
			fRec9[1] = fRec9[0];
			fRec10[1] = fRec10[0];
			fRec12[1] = fRec12[0];
