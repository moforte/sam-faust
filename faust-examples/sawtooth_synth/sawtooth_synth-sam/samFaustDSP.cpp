...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("filename", "sawtooth_synth");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.1");
		m->declare("name", "sawtooth_synth");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("sawtooth_synth");
		ui_interface->declare(&fHslider0, "midi", "ctrl 1");
		ui_interface->addHorizontalSlider("Ctrl Value IN (Ctrl 1)", &fHslider0, 60.0f, 0.0f, 127.0f, 1.0f);
		ui_interface->addNumEntry("bend", &fEntry2, 1.0f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->addNumEntry("freq", &fEntry1, 200.0f, 40.0f, 2000.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow1 = (7.87401586e-06f * ((float(fEntry0) * fSlow0) * float(fHslider0)));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp1 = std::max(1.00000001e-07f, std::fabs((fSlow2 * fRec3[0])));
			float fTemp2 = (fRec1[1] + (fConst1 * fTemp1));
			float fTemp3 = (fTemp2 + -1.0f);
			int iTemp4 = (fTemp3 < 0.0f);
			fRec1[0] = (iTemp4?fTemp2:fTemp3);
			float fRec2 = (iTemp4?fTemp2:(fTemp2 + ((1.0f - (fConst0 / fTemp1)) * fTemp3)));
			float fTemp5 = (fRec0[0] * ((2.0f * fRec2) + -1.0f));
