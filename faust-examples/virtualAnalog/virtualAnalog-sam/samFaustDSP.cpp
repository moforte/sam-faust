...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow61 = (fConst5 * powf(2.0f, ((fSlow60 + (fSlow15 + float(iSlow58))) + -2.0f)));
		...
		float fSlow76 = (fSlow35 * float(fVslider39));
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			fRec0[0] = ((((((((1.0f - fTemp36) - (2.0f * (fTemp39 * fTemp40))) * fRec16) / (sqrtf(fTemp108) * fTemp110)) + ((((fTemp104 * fTemp41) / fTemp92) + (fRec15[1] * fTemp106)) + (2.0f * ((fRec15[0] * fTemp40) / fTemp110)))) * (iSlow49?(((0.25f * ((fTemp29 + 1.0f) * fRec1[0])) + 1.0f) * fRec33[0]):fRec33[0])) * fRec34[0]) / fTemp35);
