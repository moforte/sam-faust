...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("Volume-01", &fVslider0, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider1, "midi", "ctrl 2");
		ui_interface->declare(&fVslider1, "tooltip CC-2", "");
		ui_interface->addVerticalSlider("Volume-02", &fVslider1, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider2, "midi", "ctrl 3");
		ui_interface->declare(&fVslider2, "tooltip CC-3", "");
		ui_interface->addVerticalSlider("Volume-03", &fVslider2, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider3, "midi", "ctrl 4");
		ui_interface->declare(&fVslider3, "tooltip CC-4", "");
		ui_interface->addVerticalSlider("Volume-04", &fVslider3, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider4, "midi", "ctrl 5");
		ui_interface->declare(&fVslider4, "tooltip CC-5", "");
		ui_interface->addVerticalSlider("Volume-05", &fVslider4, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider5, "midi", "ctrl 6");
		ui_interface->declare(&fVslider5, "tooltip CC-6", "");
		ui_interface->addVerticalSlider("Volume-06", &fVslider5, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider6, "midi", "ctrl 7");
		ui_interface->declare(&fVslider6, "tooltip CC-7", "");
		ui_interface->addVerticalSlider("Volume-07", &fVslider6, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider7, "midi", "ctrl 8");
		ui_interface->declare(&fVslider7, "tooltip CC-8", "");
		ui_interface->addVerticalSlider("Volume-08", &fVslider7, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider8, "midi", "ctrl 9");
		ui_interface->declare(&fVslider8, "tooltip CC-9", "");
		ui_interface->addVerticalSlider("Volume-09", &fVslider8, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider9, "midi", "ctrl 10");
		ui_interface->declare(&fVslider9, "tooltip CC-10", "");
		ui_interface->addVerticalSlider("Volume-10", &fVslider9, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider10, "midi", "ctrl 11");
		ui_interface->declare(&fVslider10, "tooltip CC-11", "");
		ui_interface->addVerticalSlider("Volume-11", &fVslider10, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider11, "midi", "ctrl 12");
		ui_interface->declare(&fVslider11, "tooltip CC-12", "");
		ui_interface->addVerticalSlider("Volume-12", &fVslider11, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider12, "midi", "ctrl 13");
		ui_interface->declare(&fVslider12, "tooltip CC-13", "");
		ui_interface->addVerticalSlider("Volume-13", &fVslider12, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider13, "midi", "ctrl 14");
		ui_interface->declare(&fVslider13, "tooltip CC-14", "");
		ui_interface->addVerticalSlider("Volume-14", &fVslider13, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider14, "midi", "ctrl 15");
		ui_interface->declare(&fVslider14, "tooltip CC-15", "");
		ui_interface->addVerticalSlider("Volume-15", &fVslider14, 0.0f, -70.0f, 4.0f, 0.100000001f);
		ui_interface->declare(&fVslider15, "midi", "ctrl 16");
		ui_interface->declare(&fVslider15, "tooltip CC-16", "");
		ui_interface->addVerticalSlider("Volume-16", &fVslider15, 0.0f, -70.0f, 4.0f, 0.100000001f);
