...
class mydsp : public dsp {
 ...
 public:
	...
	virtual void instanceResetUserInterface() {
		...
		fVslider4 = FAUSTFLOAT(0.22f);
		fVslider5 = FAUSTFLOAT(0.0f);
		fVslider6 = FAUSTFLOAT(0.75f);
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->declare(&fVslider4, "midi", "ctrl 50");
		ui_interface->declare(&fVslider4, "style", "knob");
		ui_interface->addVerticalSlider("Delay", &fVslider4, 0.219999999f, 0.0f, 1.0f, 1.0f);
		ui_interface->declare(&fVslider3, "1", "");
		ui_interface->declare(&fVslider3, "midi", "ctrl 2");
		ui_interface->declare(&fVslider3, "style", "knob");
		ui_interface->declare(&fVslider3, "unit", "Hz");
		ui_interface->addVerticalSlider("Rate", &fVslider3, 0.5f, 0.0f, 10.0f, 0.00999999978f);
		ui_interface->declare(&fVslider6, "3", "");
		ui_interface->declare(&fVslider6, "midi", "ctrl 3");
		ui_interface->declare(&fVslider6, "style", "knob");
		ui_interface->addVerticalSlider("Depth", &fVslider6, 0.75f, 0.0f, 1.0f, 0.00100000005f);
		ui_interface->declare(&fVslider1, "5", "");
		ui_interface->declare(&fVslider1, "midi", "ctrl 4");
		ui_interface->declare(&fVslider1, "style", "knob");
		ui_interface->addVerticalSlider("Feedback", &fVslider1, 0.0f, -0.995000005f, 0.99000001f, 0.00100000005f);
		ui_interface->declare(&fVslider2, "7", "");
		ui_interface->declare(&fVslider2, "midi", "ctrl 54");
		ui_interface->declare(&fVslider2, "style", "knob");
		ui_interface->addVerticalSlider("Waveshape", &fVslider2, 0.0f, 0.0f, 1.0f, 0.00100000005f);
		...
		ui_interface->declare(&fVslider5, "midi", "ctrl 49");
		ui_interface->declare(&fVslider5, "style", "knob");
		ui_interface->addVerticalSlider("Invert", &fVslider5, 0.0f, 0.0f, 1.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->closeBox();
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow4 = (0.5f * (1.0f - fSlow2));
		float fSlow5 = (2003.0f * float(fVslider4));
		int iSlow6 = int(float(fVslider5));
		float fSlow7 = (fConst2 * float(fVslider6));
